...
# ./dns -p 3333 -f bad_domain_name -s 8.8.8.8 			        ipv4 autorativní    server
# ./dns -p 3333 -f bad_domain_name -s 127.0.0.53			    ipv4 neautorativní  server
# ./dns -p 3333 -f bad_domain_name -s 2001:4860:4860::8844		ipv6 autorativni    server
